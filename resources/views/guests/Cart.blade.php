    ...
    <div class="cart-body">
            ...
            <div class="cart">
                ...
                <div class="cart-info">
                    <div class="brand-value">
                        <h3>Iphone XS Max 256GB
                            <br><label>Chọn màu :</label>
                            <input name="product-color" type="radio" value="color-1" alt="/"><span
        ...
        <div class="guest-info">
            ...
            <div class="info">
                ...
                <label>Email:</label><input type="text" name="email" placeholder="Nhập Email">
            </div>
            <div class="clear"></div>
            <button type="button" class="button" name="order"><strong>ĐẶT HÀNG</strong></button>
            <div class="clear"></div>
        </div>
