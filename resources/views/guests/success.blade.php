...
@section('content')
    ...
    <div class="message-body">
        <div class="message-content">
            ...
            <h2 style="font-size: 200%; color: red; text-align: center; padding-bottom: 20px; border-bottom: 1px solid #e5e5e5;">Chúng tôi sẽ liên hệ với bạn</h2>
            <h2 style="font-size: 200%; color: red; text-align: center; padding-bottom: 20px; border-bottom: 1px solid #e5e5e5;">Nếu có thắc mắc gì hãy liên hệ vs chúng tôi: 0905223344</h2>
